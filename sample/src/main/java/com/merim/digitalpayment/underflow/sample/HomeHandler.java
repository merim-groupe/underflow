...
import com.merim.digitalpayment.underflow.sample.form.LoginForm;
...
import com.merim.digitalpayment.underflow.sample.security.MyUserRepresentation;
...
public class HomeHandler extends FlowDTOWrapperTemplateHandler implements WebForm {
    ...
    @Produces(MediaType.TEXT_HTML)
    @GET
    @Path("/jakarta-exception")
    public Result jakartaException() {
        if (true) {
